...
```sh
node index.js unicom --user 1*** --password 11****11 --appid f7af****ebb
```
...
### crontab 任务示例
在8-20小时之间每隔60分钟尝试运行可运行的脚本子任务
```txt
*/60 8-20 * * * /bin/node /workspace/AutoSignMachine/index.js unicom --user 1******5 --password 7****** --appid 1************9
```
